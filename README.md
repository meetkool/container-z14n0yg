...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-z14n0yg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-z14n0yg.containers.anotherwebservice.com/
...
```
git clone git@github.com:meetkool/container-z14n0yg.git
cd container-z14n0yg
```
...
```
docker attach container-z14n0yg
```
